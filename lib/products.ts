...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    slug: "agent",
    name: "钢铁侠人格智能体",
    subtitle: "与具备托尼·斯塔克式思维、幽默和行动力的 AI 智能体对话。",
    description:
      "以钢铁侠人格为核心，融合工程思维、机智表达和任务拆解能力，探索沉浸式角色智能体体验。",
    targetUser: "钢铁侠爱好者、AI 角色互动用户、需要创意与决策陪练的用户",
    painPoint: "通用 AI 缺少鲜明人格，回答容易模板化，难以形成有记忆点的持续互动体验。",
    hypothesis:
      "AI 能否通过稳定的钢铁侠人格、上下文策略和行动导向的回答，带来更有沉浸感的多轮互动体验。",
    status: "可体验",
    tags: ["钢铁侠", "AI Agent", "人格智能体", "多轮对话"],
    detailUrl: "/experiments/agent",
    demoUrl: "https://ironman-ai-chat.vercel.app/",
    demoAvailable: true,
    background:
      "角色型 AI 的难点不只是能聊天，而是能在多轮互动中保持身份、语气和边界。这个实验以钢铁侠人格为载体，验证鲜明人设、工程化思考与互动节奏能否稳定共存。",
    whyAI:
      "钢铁侠人格互动依赖生成式表达、上下文理解、风格保持和任务推理。AI 能在保留机智语气的同时拆解问题、提出方案，并根据多轮对话持续调整回应。",
    targetUsers: [
      {
        title: "钢铁侠爱好者",
        description: "希望获得更有代入感的角色对话体验。",
      },
      {
        title: "创意与产品工作者",
        description: "需要一个善于拆解问题、敢于挑战假设的思考搭档。",
      },
      {
        title: "普通体验用户",
        description: "想体验兼具幽默、行动力和工程思维的 AI 对话。",
      },
    ],
    features: [
      { title: "钢铁侠人格", description: "保持自信、机智、直接且行动导向的表达。" },
      { title: "多轮上下文", description: "在连续对话中理解目标并延续任务脉络。" },
      { title: "工程化建议", description: "把复杂问题拆解为可执行的方案与优先级。" },
    ],
    workflow: [
      { title: "提出任务", description: "用自然语言描述问题、目标或需要讨论的想法。" },
      { title: "分析挑战", description: "智能体以钢铁侠式工程思维识别关键矛盾。" },
      { title: "生成方案", description: "给出直接、清晰并带有优先级的行动建议。" },
      { title: "持续对话", description: "围绕反馈迭代方案，并保持人格与上下文连续。" },
    ],
    currentVersion: [
      "已上线可交互的钢铁侠人格智能体。",
      "支持围绕问题、创意和任务进行多轮对话。",
    ...
    mockResult: [
      {
        ...
        items: [
          "你：帮我评估一下这次产品改版的风险。",
          "钢铁侠智能体：收到。先扫描关键链路，再按影响范围给风险排个优先级。",
        ],
      },
    ],
  },
